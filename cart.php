<?php
    ...
    $user_row = mysqli_fetch_assoc($select_query);
    $user_id = $user_row['id'];
    // $user_id=$_SESSION['id'];
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>NGN <?php echo $sum;?></th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm Order</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>

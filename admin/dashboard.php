    ...
    <body>
        <div>
           ...
           <div class="container" style="margin-top: 10px;">
              ...
              <?php
                $select_user_product = "SELECT * FROM items";
                            ...
                            <table class="table mb-0">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><img src="../img/<?php echo $row['image'];?>" alt="<?php echo $row['name'];?>" width="50" height="50"></td>
                                  <td><a href="dashboard.php?delete=1" class="btn btn-block btn-danger" name="add">Delete</a></td>
                                </tr>
                              <?php }}
                                else {
                                  echo "<div class='alert alert-danger text-center'>No products in db</div>";
                                }
                              ?>
                              </tbody>
                            </table>

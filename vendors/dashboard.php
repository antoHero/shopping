           ...
           <div class="container" style="margin-top: 10px;">
              <?php
                if(isset($_SESSION['email'])) {
                  ...
                  die("<p class='alert alert-danger text-center'>You are not allowed to view this page.</p>");
                }
              ?>
              
              
              <?php
                $select_user_product = "SELECT * FROM items WHERE user_id='$user_id'";
                            ...
                            <table class="table mb-0">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><img src="../img/<?php echo $row['image'];?>" alt="Cannon" width="50" height="50"></td>
                                  <td><a href="dashboard.php?delete=1" class="btn btn-block btn-danger" name="add">Delete</a></td>
                                </tr>
                              <?php }}
                                else {

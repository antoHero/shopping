                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                        <div class="justify-content-center">
                          ...
                          ?>
                          <form method="post" action="edit_product_script.php" enctype="multipart/form-data">
                              <div class="form-group">
                                  <input type="text" class="form-control" name="name" value="<?php echo $name;?>" required="true">
                              </div>
                              <div class="form-group">
                                  <input type="text" class="form-control" name="price" value="<?php echo $price;?>" required="true">
                              </div> 
                              <div class="form-group">
